                ...
                <div
                  ...
                  <div className="flex w-full items-center justify-between px-3 text-text-default-secondary">
                    <span className="inline-flex items-center gap-x-1 text-sm font-light">
                      ...
                      <span>·</span>
                      <span>
                        {formatRelativeTime(memo.postedAt as any as string)}
                      </span>
                    </span>
                      ...
                      {/* <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Button
                            ...
                            size="icon"
                            variant="ghost">
                            <span className="i-ri-more-fill text-text-default-secondary h-4 w-4" />
                          </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent className="w-24 min-w-0 text-xs">
                          <DropdownMenuItem
                            onClick={(e) => {
                              e.stopPropagation()
                              handleDeleteMemo(memo)
                            }}>
                            <span className="i-ri-delete-bin-line text-text-default-secondary h-4 w-4" />
